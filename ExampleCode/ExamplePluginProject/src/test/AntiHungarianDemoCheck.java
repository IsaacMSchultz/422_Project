...
public class AntiHungarianDemoCheck extends AbstractCheck {
    ...
    public int[] getDefaultTokens() {
    	System.out.println("getDefaultTokens");
	...
	public int[] getRequiredTokens() {
		System.out.println("getRequiredTokens");
		// TODO Auto-generated method stub
		return new int[0];
	}
