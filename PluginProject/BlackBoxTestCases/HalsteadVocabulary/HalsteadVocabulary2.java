class HalsteadVocabulary2
{
	//Halstead Vocabulary: Sum of Unique Operators (n1) and Operands (n2) in the file n = n1 + n2
	
	// ASSIGN token type "=" is an operator only first occurence should count: n1 = 1
	// LITERAL_INT token type "int' is an operand ony first occurence should count n2 = 1
	...
	// Parenthesis in operation (left and right) should each count as unique operator
	...
	// +, -, /, *, +=, -=, *=, /=, public bool test = false;, public double test1 = 0.0
	// n2 + 0 = 3, n1 + 0 = 15
