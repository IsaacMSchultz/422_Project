...
public class OperatorCountTest {
    ...
    int[] meme = {TokenTypes.ASSIGN, TokenTypes.PLUS, TokenTypes.MINUS, TokenTypes.DIV, TokenTypes.STAR,
    ...
    public void testVisit() {
        ...
        assertEquals(expectedTokens.length, test.getUniqueOperators()); // does not catch all the different kinds of operators!
    }
}
